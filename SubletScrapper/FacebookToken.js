...
exports.longlivetoken = function(req, res, next){
	...
	console.log(process.env.NODE_ENV)
	let CLIENT_ID = '115765432474914'
	let CLIENT_SECRET = '61eeb4de2ccf4180cec67f86ba9a0e45'
	if (process.env.NODE_ENV === 'production') {
		// production
		CLIENT_ID = '1492022030811505'
		CLIENT_SECRET = 'ab7ff18d40625c64f6a12516f5be8de2'
	}
